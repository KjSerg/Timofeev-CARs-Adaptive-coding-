...
/* harmony import */ var _components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/utils/_helpers */ "./resources/js/components/utils/_helpers.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  wrapArticleTables();
  createSidebarList();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.sidebar-js a', function (e) {
    e.preventDefault();
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.single-article-comment__dislike, .single-article-comment__like', function (e) {
    e.preventDefault();
    var $t = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      ...
      if (!r) return;
      if (!(0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.isJsonString)(r)) console.log(r);
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find(".single-article-comment__like[data-id=\"".concat(id, "\"] .counter")).text(res.like || 0);
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find(".single-article-comment__dislike[data-id=\"".concat(id, "\"] .counter")).text(res.dislike || 0);
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('click', '.next-comments-link-js', function (e) {
    e.preventDefault();
    var $t = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var href = $t.attr('href');
    if (href === undefined || href === '') return;
    $t.addClass('not-active');
    (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.showPreloader)();
    jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax({
      type: 'GET',
      url: href
    }).done(function (r) {
      (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.hidePreloader)();
      $t.removeClass('not-active');
      if (!r) return;
      var parser = new DOMParser();
      var $r = jquery__WEBPACK_IMPORTED_MODULE_0___default()(parser.parseFromString(r, "text/html"));
      var $pagination = $r.find('.single-article-comments-controls');
      var $catalog = $r.find('#article-comments-list');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find('.single-article-comments-controls').html($pagination.html());
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find('#article-comments-list').append($catalog.html());
    });
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('submit', '.comments-form-js', function (e) {
    e.preventDefault();
...
function wrapArticleTables() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find('.text table').each(function () {
    var $table = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this);
    var $wrap = $table.closest('.single-article-table');
    if ($wrap.length === 0) $table.wrap('<div class="pricing-table single-article-table" />');
  });
}
function createSidebarList() {
  var $text = jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find('.single-article-container .text');
  var $sidebar = jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).find('.sidebar-js');
  ...
  $text.each(function (i) {
    ...
    $headers.each(function (index) {
      ...
      html += "<li><a href=\"#".concat(id, "\">").concat(text, "</a></li>");
    });
  });
...
function validateForm($form) {
  ...
  $form.find('input, textarea').each(function (_, input) {
    ...
    if ($input.attr('required') && (!value || regExp && !regExp.test(value))) {
      ...
      (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.moveToElement)($label);
    } else {
  ...
  if ($consent.length && !$consent.prop('checked')) {
    ...
    isValid = false;
    (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.moveToElement)($consent.closest('.form-consent'));
  } else {
  ...
  if ($form.find('.address-js').length > 0) {
    if ($form.find('.address-js').val() !== $form.find('.address-js').attr('data-selected')) {
      ...
      (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.moveToElement)($form.find('.address-js').closest('.form-label'));
    } else {
...
function sendRequest(options) {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default().ajax(options).done(function (response) {
    if (response) {
      (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.hidePreloader)();
      var isJson = (0,_components_utils_helpers__WEBPACK_IMPORTED_MODULE_2__.isJsonString)(response);
      if (isJson) {
        ...
        var comment_html = data.comment_html || '';
